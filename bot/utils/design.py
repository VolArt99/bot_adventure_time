...
BRAND_VOICE = {
    ...
    "approved_member_start": (
        ...
        "📝 Рассказ о себе в теме группы\n\n"
        "Потом:\n"
        "• открой афишу 👇\n"
        "• запишись на ближайшую встречу"
    ),
    ...
    "birthday_saved_hint": "В этот день мы поздравим тебя в теме «Общение и не только» 🎂",
    ...
    "afisha_iphone_hint_body": (
        "Перешли это сообщение себе в «Избранное» — "
        "после этого переход на карточку должен сработать."
    ),
    "approval_required": (
        "Доступ к боту ещё не подтверждён. Напиши боту в ЛС /start — "
        "заявка уйдёт капитану, после одобрения кнопки заработают 🧭"
    ),
    "carpool_driver_seats": "🚗 Сколько мест в машине возьмёшь (с тобой)? Введи число:",
    "carpool_choose_driver": "🚗 К кому присоединиться в поездку?",
    "carpool_driver_added": "Ты за рулём — места обновлены! 🚗",
    "carpool_passenger_added": "Присоединился к водителю — в путь! 👥",
    "carpool_seek_added": "🙋 Отметил «ищу попутку»",
    "carpool_seek_removed": "Снял отметку «ищу попутку»",
    "command_limit_member": "Сегодня лимит исчерпан — завтра снова в путь, или напиши капитану ⛵",
    "command_limit_admin": "Сегодня лимит исчерпан — попробуй завтра ⛵",
    "command_limit_outsider": "Лимит до одобрения исчерпан — попробуй завтра ⛵",
    "notification_mode_saved": "Режим уведомлений сохранён ✅",
}
...
WIZARD_PROMPTS = {
    ...
    "date": "📅 Какая дата начала?\n\nВыбери кнопку ниже или введи вручную:\n<b>ДД.ММ.ГГГГ</b>",
    "time": "🕒 Во сколько начинаем?\nФормат: <b>ЧЧ:ММ</b>",
    ...
    "period_end_time": "🕒 Время окончания периода?\nФормат: <b>ЧЧ:ММ</b>",
    "period_end": "🏁 Когда заканчивается период? Формат: ДД.ММ.ГГГГ ЧЧ:ММ",
    "duration": (
        "⏱ Сколько длится маршрут?\n"
        "Примеры: <b>1 ч 30 мин</b>, <b>90 мин</b>, <b>2</b>\n"
        "(число без единиц — бот уточнит: часы или минуты)\n"
        "Или «пропустить»."
    ),
    "location": "📍 Куда направимся? (или «пропустить»)",
    "link": "🔗 Ссылка на что угодно (сайт, чат, регистрация) или «пропустить»:",
